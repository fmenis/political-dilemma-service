...
psql -v ON_ERROR_STOP=1 --username "$POSTGRES_USER" --dbname "$POSTGRES_DB" <<-EOSQL
    ...
    CREATE TABLE IF NOT EXISTS users_roles (
        ...
        CONSTRAINT fk_assign_by FOREIGN KEY(user_id) REFERENCES users(id) ON DELETE SET NULL
    );
    ...
    CREATE TABLE IF NOT EXISTS articles (
        ...
        CONSTRAINT fk_deletedBy FOREIGN KEY("deletedBy") REFERENCES users("id") ON DELETE SET NULL
    );
