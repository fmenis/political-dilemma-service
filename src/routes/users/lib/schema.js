...
export function sUserList() {
  return S.object()
    ...
    .required()
    .prop('roles', S.string().minLength(3))
    ...
    .required()
    .prop('publishedLaws', S.number())
    .description(`Number of laws published by the user`)
    .required()
    .prop('draftLaws', S.number())
    .description(`Number of laws created by the user`)
    .required()
    .prop('publishedArticles', S.number())
    .description(`Number of articles published by the user`)
    .required()
    .prop('draftArticles', S.number())
